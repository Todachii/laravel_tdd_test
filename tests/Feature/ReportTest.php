...
class ReportTest extends TestCase
{
     ...
     * @test
     */
    public function POST_api_customersにnameが含まれない場合に422UnprocessableEntityが返却される()
    {
        $params = [];
        $response = $this->postJson('api/customers', $params);
     ...
     * @test
     */
    public function POST_api_customersにnameが空の場合に422UnprocessableEntityが返却される()
    {
        $params = ['name' => ''];
        $response = $this->postJson('api/customers', $params);
        $response->assertStatus(\Illuminate\Http\Response::HTTP_UNPROCESSABLE_ENTITY);
     ...
     * @test
     */
    public function POST_api_customersのエラーメッセージの確認()
    {
        $params = ['name' => ''];
        $response = $this->postJson('api/customers', $params);
        $error_response = [
     ...
     * @test
     */
    public function api_customersにPUTメソッドでアクセスできる()
    {
     ...
     * @test
     */
    public function api_customersにDELETEメソッドでアクセスできる()
    {
